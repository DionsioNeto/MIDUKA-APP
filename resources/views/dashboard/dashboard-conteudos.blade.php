            ...
            @else
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach ($itens as $item)
                        <div class="flex flex-col bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm hover:shadow-lg transition-all">
                            ...
                            <div class="flex justify-between items-center p-4 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <form action="/dashboard/usuario/{{ $item->id }}" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir?');">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
                    ...
                    @foreach ($itens as $item)
                        <div class="flex flex-col bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm hover:shadow-lg transition-all">
                            ...
                            <div class="flex-1 flex flex-col justify-between p-4">
                                <div class="mt-2">
                                    <a href="/dashboard/usuario/{{ $item->id }}"
                                       class="inline-flex items-center text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:underline transition">
                                        Gerenciar Conteúdo
